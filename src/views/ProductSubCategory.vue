                        ...
                        <div><!--filter_products-->
							<div>
								<ul class="nav nav-pills nav-stacked">
									<li><button class="btn-primary" @click="filter('productSubCategory','desc','timestamp')">Newest Arrival</button></li>
        							<li><button class="btn-primary" @click="filter('productSubCategory','desc','productPrice')">Price High To Low</button></li>
        							<li><button class="btn-primary" @click="filter('productSubCategory','asc','productPrice')">Price Low To High</button></li>
								</ul>
							</div>
						</div><!--/filter_products-->
                        <hr>
...
export default {
  ...
  async beforeCreate(){
	...
	var data={
		'productSubCategory': this.$route.params.subCategoryName
	};
      try{
        var response = await PostService.getSubCategoryProduct(data);
  ...
  methods:{
      async filter(categoryType,orderByType,orderByValue){
      var data = {
        'categoryType':categoryType,
        'categoryValue':this.$route.params.subCategoryName,
        'orderByType':orderByType,
        'orderByValue':orderByValue,
      }
      try{
        var response = await PostService.filter(data);
        this.products=response.data
      } catch(err){
        this.error=err.message;
      }
