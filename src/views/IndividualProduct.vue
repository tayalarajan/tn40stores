                    ...
                    <div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img :src="imageUrl" width="500" height="500" alt="" />
							</div>
							<div id="similar-product" class="carousel slide" data-ride="carousel">
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
										<div class="item active">
										  <a v-on:click="imageUrl=arrayOfImageUrls[0]"><img :src="arrayOfImageUrls[0]" width="100" height="100" alt=""></a>
										</div>
										<div class="item" v-if="arrayOfImageUrls.length>=2">
										  <a v-on:click="imageUrl=arrayOfImageUrls[1]"><img :src="arrayOfImageUrls[1]" width="100" height="100" alt=""></a>
										</div>
										<div class="item" v-if="arrayOfImageUrls.length>=3">
										  <a v-on:click="imageUrl=arrayOfImageUrls[2]"><img :src="arrayOfImageUrls[2]" width="100" height="100" alt=""></a>
										</div>
										<div class="item" v-if="arrayOfImageUrls.length>=4">
										  <a v-on:click="imageUrl=arrayOfImageUrls[3]"><img :src="arrayOfImageUrls[3]" width="100" height="100" alt=""></a>
										</div>
									</div>
							</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								<h1 style="color: #5BBCEC">{{product.productTitle}}</h1>
								<h3>{{product.productName}}</h3>
								<span>
									<h4 class="btn-success">Save %{{product.productSavingPercentage}}</h4>
									<span>IND RS{{product.productPrice}}</span>
									<h4 style="text-decoration:line-through;">MRP RS{{product.productMRP}}</h4>
									<button v-on:click="addToCart(product)" class="btn btn-fefault cart">
										<i class="fa fa-shopping-cart"></i>
										Add to cart
									</button>
								</span>
								<p><b>Availability:</b> {{product.productStockStatus}}</p>
                        ...
                        <div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									...
									<p><b>Category</b></p>
									<router-link :to="{name: 'ProductCategory', params: {categoryName: product.productCategory}}">{{product.productCategory}}</router-link>
									<p><b>Sub Category</b></p>
									<router-link :to="{name: 'ProductSubCategory', params: {subCategoryName: product.productSubCategory}}">{{product.productSubCategory}}</router-link>
									<p><b>Write Your Review</b></p>
									<form action="#">
										<textarea name="" placeholder="Write Your Review" v-model="comment"></textarea>
										<button type="button" class="btn btn-default pull-right" v-on:click="gotoComment()">
											Submit
										</button>
									</form>
								</div>
										...
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img :src="recommendedProducts[index].arrayOfImageUrls[0]" alt="" />
								...
								<div class="item">	
									...
									>
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img :src="recommendedProducts[index+3].arrayOfImageUrls[0]" alt="" />
								...
								<div class="item">	
									...
									>
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img :src="recommendedProducts[index+6].arrayOfImageUrls[0]" alt="" />
								...
								<div class="item">	
									...
									>
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img :src="recommendedProducts[index+9].arrayOfImageUrls[0]" alt="" />
...
export default {
  ...
  async beforeCreate(){
    try{
		...
		this.arrayOfImageUrls=this.product.arrayOfImageUrls
		this.imageUrl=this.arrayOfImageUrls[0]
  ...
  methods:{
	...
	async addToCart(product){
		...
		if(product.productId==undefined){
			product.productId=this.$route.params.productId;
		}
