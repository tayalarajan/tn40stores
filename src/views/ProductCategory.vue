						...
						<div><!--filter_products-->
							<div>
								<ul class="nav nav-pills nav-stacked">
									<li><button class="btn-primary" @click="filter('productCategory','desc','timestamp')">Newest Arrival</button></li>
        							<li><button class="btn-primary" @click="filter('productCategory','desc','productPrice')">Price High To Low</button></li>
        							<li><button class="btn-primary" @click="filter('productCategory','asc','productPrice')">Price Low To High</button></li>
								</ul>
							</div>
						</div><!--/filter_products-->
						<hr>
...
export default {
  ...
  async beforeCreate(){
	...
	var data={
		'productCategory': this.$route.params.categoryName
	};
      try{
        var response = await PostService.getCategoryProduct(data);
  ...
  methods:{
	async filter(categoryType,orderByType,orderByValue){
      var data = {
        ...
        'categoryValue':this.$route.params.categoryName,
